...
def parse_args():
    ...
    parser.add_argument("--num-adversaries", type=int, default=0, help="number of advexersaries")
    ...
    # Checkpointing
    parser.add_argument("--exp-name", type=str, default="Jingdi", help="name of the experiment")
